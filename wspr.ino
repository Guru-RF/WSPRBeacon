...
#define WSPR_FREQ_60M       536470000ULL   //60m     5.364700
#define WSPR_FREQ_60M_STR   "5,364,700" 
...
#define WSPR_FREQ        WSPR_FREQ_60M      // set the band here 
#define WSPR_FREQ_STR    WSPR_FREQ_60M_STR  // set the band display string here 
//---------------------------------------------------------------------
...
void setup()
{
  ...
  WSPRData.CallSign[3] = 'U';    
  WSPRData.CallSign[4] = 'R';    
  WSPRData.CallSign[5] = 'E';    
